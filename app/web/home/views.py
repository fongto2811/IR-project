...
CA_CERTS = os.path.realpath(os.path.join(os.path.dirname(__name__), 'app', 'elasticsearch-8.6.2', 'config', 'certs', 'http_ca.crt'))
index_name = "product"
type_name = "_doc"
path = os.path.realpath(os.path.join(os.path.dirname(__name__), 'app', 'documents'))
